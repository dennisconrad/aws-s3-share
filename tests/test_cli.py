...
from aws_s3_share.cli import get_object_key
...
class TestGetObjectKey:
    ...
    def test_tar_gzip_extension(self):
        ...
        with patch('aws_s3_share.cli.generate_random_prefix', return_value='abc123'):
    ...
    def test_gzip_extension(self):
        ...
        with patch('aws_s3_share.cli.generate_random_prefix', return_value='xyz789'):
